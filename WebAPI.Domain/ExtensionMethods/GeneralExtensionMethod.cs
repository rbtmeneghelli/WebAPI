...
public sealed class GeneralExtensionMethod
{
    ...
    public string RemoveSpecialCharacters(string text)
    {
        ...
        string result = Constants.GetEmptyString();
        string partText = Constants.GetEmptyString();
    ...
    {
        return Regex.Replace(input, "<.*?>", Constants.GetEmptyString());
    }
    ...
    {
        string color = Constants.GetEmptyString();
        while (true)
        {
            color = GetColorHex();
    ...
    {
        DateTime currentDate = Constants.GetDateTimeNowFromBrazil();
        Dictionary<EnumJobTypeExecution, string> dictionary = new Dictionary<EnumJobTypeExecution, string>();
    ...
    {
        int count = 0;
        string token = Constants.GetEmptyString();
