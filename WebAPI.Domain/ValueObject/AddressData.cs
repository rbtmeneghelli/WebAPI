...
public class AddressData : GenericEntity
{
    ...
    = (id, modelCepAPI.District, cep, modelCepAPI.Complement, modelCepAPI.Ddd, modelCepAPI.Gia, Constants.GetDateTimeNowFromBrazil(), modelCepAPI.Ibge, modelCepAPI.Location,
    ...
    public AddressData(string cep, AddressData modelCepAPI)
    {
        ...
        Ddd = modelCepAPI.Ddd;
        Gia = modelCepAPI.Gia;
        UpdateTime = Constants.GetDateTimeNowFromBrazil();
